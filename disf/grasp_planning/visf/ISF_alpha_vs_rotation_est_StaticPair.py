...
class ISF_alpha_vs_rotation_est_StaticPair:  # ISF
    def __init__(self, domain_object: DomainObject):
        self.ipfo_alpha_vs_rotation_est = domain_object.ipfo_alpha_vs_rotation_est
        # ---
    ...
    def run(self, rotvec0: np.ndarray = None, return_all: bool = False) -> ISFResult:
        ...
        self.ipfo_alpha_vs_rotation_est.ipfo_palm_Rt_opt.initialize_Rt_with_R0(R0=R0)
        ...
        # ==============================================================================
        result = self.ipfo_alpha_vs_rotation_est.compute(source_set, target_set, d)
        # ==============================================================================
