...
from disf.value_object import AppJointIPFOErrors
...
def compute_all_errors_app_joint(
    ...
    if verbose:
        print(
            f"Err={format_vector([Err], decimal_places=4)} | Ep={format_vector([Ep], decimal_places=4)} | En={format_vector([En], decimal_places=4)} | Ea={format_vector([Ea], decimal_places=4)}")
    # -------------------
