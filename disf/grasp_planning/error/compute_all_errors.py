...
def compute_all_errors(
    ...
    if verbose:
        print(
            f"Err={format_vector([Err], decimal_places=4)} | E_point2point={format_vector([E_point2point], decimal_places=4)} | Ep={format_vector([Ep], decimal_places=4)} | En={format_vector([En], decimal_places=4)}")
        # import ipdb ; ipdb.set_trace()
    # -------------------
    return IPFOErrors(
        total=Err,
