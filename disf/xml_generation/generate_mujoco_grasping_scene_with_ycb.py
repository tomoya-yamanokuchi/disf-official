...
from disf.service import indent_tree

from disf import ASSETS_DIR
...
def generate_mujoco_grasping_scene_with_ycb(
    ...
    ET.SubElement(asset, "texture",
                  {"type": "skybox", "builtin": "gradient", "rgb1": "0.3 0.5 0.7", "rgb2": "0 0 0", "width": "512",
                   "height": "3072"})
    ET.SubElement(asset, "texture", {"type": "2d", "name": "groundplane", "builtin": "checker", "mark": "edge",
                                     "rgb1": "0.2 0.3 0.4", "rgb2": "0.1 0.2 0.3", "markrgb": "0.8 0.8 0.8",
                                     "width": "300", "height": "300"})
    ET.SubElement(asset, "material",
                  {"name": "groundplane", "texture": "groundplane", "texuniform": "true", "texrepeat": "5 5",
                   "reflectance": "0.2"})
    ET.SubElement(asset, "texture",
                  {"name": "cube_surface", "file": "./assets/texture/iris_block.png", "gridsize": "3 4",
                   "gridlayout": ".U..LFRB.D.."})
    ET.SubElement(asset, "material",
                  {"name": "obj_material", "texture": "cube_surface", "specular": "1", "shininess": "0.0",
                   "rgba": "1 1 1 1"})
    ...
    ET.SubElement(table, "geom", {"name": "table", "size": "0.1 0.1 0.1", "type": "box", "rgba": "1 1 1 0.3",
...
if __name__ == "__main__":
    ...
    base_path = "../../../models/ycb"
    output_file = f"{ASSETS_DIR}/franka_emika_panda_original/generated_scene_pretty.xml"
