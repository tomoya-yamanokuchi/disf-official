from ..DexterousManipulatorEnv import DexterousManipulatorEnv
...
class PandaArmEnv(DexterousManipulatorEnv):
    ...
    def print_object_mass(self):
        ...
        print(f"object_body_mass = {object_body_mass} [kg]", tag="env", color="y", tag_color="y")
