# Modified to work with Python 3 by Tomoya Yamanokuchi, 2025
...
class MJCFBuilder:
    ...
    def add_collision_geometries(
        ...
        if decomp_success:
            ...
            for collision in collisions:
                ...
                e_.attrib["class"] = "object_collision"
        else:
    ...
    def build(
        ...
        # obj_body = etree.SubElement(worldbody_elem, "body", name=filename.stem, pos="0 0 0.2")
        if add_free_joint:
